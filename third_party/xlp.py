...
from clone_transformers.src.transformers.models.xlm.modeling_xlm import XLMModel, XLMPreTrainedModel, XLM_START_DOCSTRING, XLM_INPUTS_DOCSTRING
...
class XLMForTokenClassification(XLMPreTrainedModel):
  ...
  def save_pretrained(self, output_dir):
    ...
    data['transformer'] = self.transformer.state_dict()
    data['classifier'] = self.classifier.state_dict()
