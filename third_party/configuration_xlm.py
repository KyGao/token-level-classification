...
class XLMConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.vocab_size = params['max_vocab']
        ...
        self.use_lang_emb = use_lang_emb # True
        self.layer_norm_eps = layer_norm_eps # 1e-12
        self.bos_index = bos_index # params['bos_index']
        self.eos_index = eos_index # params['eos_index']
        self.pad_index = pad_index # params['pad_index']
        self.unk_index = unk_index # params['unk_index']
        self.mask_index = mask_index # params['mask_index']
        self.is_encoder = is_encoder # True
        self.max_position_embeddings = max_position_embeddings # 256
        self.embed_init_std = embed_init_std   # no use
        self.init_std = init_std               # no use
        ...
        self.num_labels = 18 # 18 for udpos 7 for panx
