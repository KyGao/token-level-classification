...
from xlp import XLMForTokenClassification
        ...
        if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
          if args.save_only_best_checkpoint:
            ...
            if result["f1"] > best_score:
              ...
              output_dir = os.path.join(args.output_dir, "checkpoint-best.pth")
              ...
              torch.save(model.state_dict(), os.path.join(args.output_dir, 'checkpoint-best.pth'))
